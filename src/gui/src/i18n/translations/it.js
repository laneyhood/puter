...
const it = {
  ...
  dictionary: {
    ...
    hide_desktop_icons: 'Nascondi icone del desktop',
    home: "Home",
    ...
    show_desktop_icons: 'Mostra icone del desktop',
    ...
    toolbar_auto_hide: "Nascondi automaticamente la barra degli strumenti",
